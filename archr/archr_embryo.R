...
work_dir <- paste0("/home/adufour/work/archr/archr_all_embryo")
...
createArrowFiles(inputFiles  = c("/home/adufour/work/fragencode/workspace/plus4pigs/results/run_cellranger_count/ensembl/arc_j7_108/outs/atac_fragments.tsv.gz", 
                 ...
                 sampleNames = c("J7", "J9-1", "J9-2", "J11-1", "J11-2", "J11-3", "J11-4"), 
...
archrproj <- ArchRProject(ArrowFiles = c(paste0(work_dir, "/J7.arrow"), paste0(work_dir, "/J9-1.arrow"), paste0(work_dir, "/J9-2.arrow"), paste0(work_dir, "/J11-1.arrow"), paste0(work_dir, "/J11-2.arrow"), paste0(work_dir, "/J11-3.arrow"), paste0(work_dir, "/J11-4.arrow")),
                geneAnnotation = geneAnnotation,
                genomeAnnotation = genomeAnnotation)
